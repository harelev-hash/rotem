...
6. ניקוד מדויק לחלוטין: ניקד כל מילה לפי ההגייה האמיתית שלה בעברית. אסור לשנות ניקוד של מילה כדי "להכניס" אותה לתנועות פעילות — אם המילה מכילה תנועה לא פעילה, אל תשתמש בה. לדוגמה: "מַהֵר" מנוקדת עם צירה באות ה׳ (הֵ), לא פתח (הַ).
